...
<div id="fullpage">
  ...
  <section class="section relative fp-auto-height-responsive" data-anchor="portfolio">
    <a href="#home"><img src="resource/img/btn_1_2.png" alt="상단버튼" class="section-item icon-up"></a>
    <!--<div><img src="resource/img/3-1.png" alt="포트폴리오1" class="section-item pf-img-1"></div> -->
    <div class="mousemove-effect-1-el section-item pf-img-2" data-mousemove-effect1-hor-res="0.03"
      data-mousemove-effect1-ver-res="0.03">
      <img class="block" src="resource/img/3-2.png" alt=""></div>
    <div class="mousemove-effect-1-el section-item pf-img-3" data-mousemove-effect1-hor-res="0.02"
    ...
    <div class="portfolio flex">
      <div class="pf-wrap-1">
        <div class="pf-content pf-1">
          <div>포폴1
            <a class="pf-img" href="https://picsum.photos/seed/picsum/500/600" data-lightbox="image-1" data-title="마음에 드는 배너라서, 살짝 리디자인 해봤습니다.">
        ...
        <div class="pf-content pf-2">
          <div>포폴2
            <a class="pf-img" href="https://picsum.photos/seed/picsum/1000/600" data-lightbox="image-1" data-title="이미지2">
              <img src="https://picsum.photos/seed/picsum/300/200" alt="">
            </a>
          </div>
        </div>
      ...
      <div class="pf-wrap-2">
        <div class="pf-content pf-3">
          <div>포폴3
            <a class="pf-img" href="https://picsum.photos/seed/picsum/700/600" data-lightbox="image-1" data-title="이미지3">
              <img src="https://picsum.photos/seed/picsum/300/200" alt="">
            </a>
          </div>
        </div>
        <div class="pf-content pf-4">
          <div>포폴4
            <a class="pf-img" href="https://picsum.photos/seed/picsum/500/1000" data-lightbox="image-1" data-title="이미지4">
              <img src="https://picsum.photos/seed/picsum/300/200" alt="">
            </a>
          </div>
        </div>
      ...
      <div class="pf-wrap-3">
        <div class="pf-content pf-5">
          <div>포폴5
            <a class="pf-img" href="https://picsum.photos/seed/picsum/500/300" data-lightbox="image-1" data-title="이미지5">
              <img src="https://picsum.photos/seed/picsum/300/200" alt="">
            </a>
          </div>
        </div>
        <div class="pf-content pf-6">
          <div>포폴6
            <a class="pf-img" href="https://picsum.photos/seed/picsum/500/600" data-lightbox="image-1" data-title="이미지6">
              <img src="https://picsum.photos/seed/picsum/300/200" alt="">
            </a>
          </div>
        </div>
