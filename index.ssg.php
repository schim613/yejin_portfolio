...
<div id="fullpage">
    ...
    <section class="section relative fp-auto-height-responsive" data-anchor="portfolio">
      ...
      <div class="mousemove-effect-1-el section-item pf-img-2" data-mousemove-effect1-hor-res="0.03" data-mousemove-effect1-ver-res="0.03">
  <img class="block" src="resource/img/3-2.png" alt=""></div>
      <div class="mousemove-effect-1-el section-item pf-img-3" data-mousemove-effect1-hor-res="0.02" data-mousemove-effect1-ver-res="0.02">
  <img class="block" src="resource/img/3-3.png" alt=""></div>
      <div class="mousemove-effect-1-el section-item pf-img-4" data-mousemove-effect1-hor-res="0.01" data-mousemove-effect1-ver-res="0.01">
  <img class="block" src="resource/img/3-4.png" alt=""></div> -->
      <div class="pf-wrap flex">
        <div class="pf-wrap-1">
          <div class="pf-1"><div>포폴1</div></div>
          <div class="pf-2"><div>포폴2</div></div>
        </div>
        <div class="pf-wrap-2">
          <div class="pf-3"><div>포폴3</div></div>
          <div class="pf-4"><div>포폴4</div></div>
        </div>
        <div class="pf-wrap-3">
          <div class="pf-5"><div>포폴5</div></div>
          <div class="pf-6"><div>포폴6</div></div>
        </div>
      </div>
    </section>
